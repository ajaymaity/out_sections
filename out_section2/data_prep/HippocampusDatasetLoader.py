...
def LoadHippocampusData(root_dir, y_shape, z_shape):
    ...
    for f in images:
        ...
        image = med_reshape(updated_image, new_shape=(updated_image.shape[0], y_shape, z_shape))
        label = med_reshape(updated_label, new_shape=(updated_label.shape[0], y_shape, z_shape)).astype(int)
